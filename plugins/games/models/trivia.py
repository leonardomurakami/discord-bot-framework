...
class TriviaStats(Base):
    ...
    __table_args__ = (UniqueConstraint("user_id", "guild_id", name="uq_trivia_stats_user_guild"),)
...
class TriviaAchievement(Base):
    ...
    __table_args__ = (UniqueConstraint("user_id", "guild_id", "achievement_id", name="uq_trivia_achievement_user_guild_achievement"),)
...
class GuildLeaderboard(Base):
    ...
    __table_args__ = (UniqueConstraint("guild_id", "leaderboard_type", name="uq_guild_leaderboard_type"),)
